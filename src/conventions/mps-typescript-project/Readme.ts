...
/** Atom checking for root project documentation. */
export const atom = runtime.atom((get) =>
	Effect.gen(function*() {
		...
		return Support.outcome(
			RootEntries.has(entries, 'README.md', 'File'),
			Finding.make(
				'missing-readme',
				'Repository must contain README.md.',
				'README.md'
			)
		);
	})
...
export const convention = Convention.make({
	id: ConventionId.make('mps-typescript-project/readme'),
	title: 'README.md',
	atom
});
